function [state_array, location_array, time_out, time_P_cell, P_count_vec, temp, transition_array] = Gillespie_STS_Prod_Rate_Multi_v6 (state_array, location_array, beta_array_cell, type_idx_array, time_in, time_P_cell, P_count_vec, temp, transition_array)
    ...
    if nargin == 8 %change if number of inputs change!!
