...
lambda = [10^3, 1, 1, 1, 1]; %Matlab cannot solve it!
len = length(lambda);
R0 = 10;
syms X
...
lambda = [10^3, 1, 1, 1, 1, 1, 1, 1]; %Matlab cannot solve it!
len = length(lambda);
R0 = 10;
syms X
...
lambda = [10^3, ones(1,19)]; %Matlab cannot solve it!
len = length(lambda);
R0 = 25; %changed to 25!
syms X
