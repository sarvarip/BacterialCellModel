...
parpool(10) 
index_array = [7];
index_array = [index_array, 14, 16, 23, 25];
index_array = [index_array, 14, 16, 17, 23, 25];
files = ["Run3_2019_converge_par_003_ex_7.mat"];
files = [files, "FYP_2019_converge_par_003_ex_14", "FYP_2019_converge_par_003_ex_16", "FYP_2019_converge_par_003_ex_23", "FYP_2019_converge_par_003_ex_25"];
files = [files, "FYP_2019_converge_par_0005_ex_14", "FYP_2019_converge_par_0005_ex_16", "FYP_2019_converge_par_0005_ex_17", "Run2_2019_converge_par_0005_ex_23", "FYP_2019_converge_par_0005_ex_25"];
...
parfor loopvar=1:numel(index_array) 
    ...
    if contains(files(loopvar), "0005")
    ...
    if contains(files(loopvar), "0005")
        str = ['Defproblem_0005_ex_', num2str(index)];
    else
        str = ['Defproblem_003_ex_', num2str(index)];
    end
