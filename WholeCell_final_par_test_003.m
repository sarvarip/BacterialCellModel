...
index_array = [14 17 20 23 24 25 26]; %[5 7 8 9 10]
...
%parfor index=14:26 %run2
    ...
    str = ['FYP_17_06_par_003_ex_', num2str(index)];
    parsave_final_transition_arr(str, time_ss, state_array, location_array, type_idx_array, temp, energy, energy_array, S_i, total_transcript, total_inst_gr_array, P_count_vec_array, total_P, transient_P, P_ss, time_elapsed, production_rate, growth_rate, avg_inst_growth_rate, std_inst_growth_rate, transition_array);
