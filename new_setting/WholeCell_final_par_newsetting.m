...
index_array = [0 1 2 3 5 6 7 8];
index_array = [index_array, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 22, 23, 24, 25, 26];
index_array = [index_array, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 22, 23, 24, 25, 26];
...
%parfor index=14:26 %run2
    ...
    if (loopvar > 24)
        str = ['NewSettingAug_0005_ex_', num2str(index)];
    else
        str = ['NewSettingAug_003_ex_', num2str(index)];
    end
